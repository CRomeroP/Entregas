...
public:
	...
	unsigned int GetUInt(const char* field, unsigned int default = 0, int index = -1) const;
	unsigned long long GetUID(const char* field, unsigned long long default = 0, int index = -1) const;
	...
	bool AddUInt(const char* field, unsigned int value);
	bool AddUID(const char* field, unsigned long long value);
	...
	bool AddArrayUInt(const char* field, const unsigned int* values, int size);
	bool AddArrayUID(const char* field, const unsigned long long* values, int size);
