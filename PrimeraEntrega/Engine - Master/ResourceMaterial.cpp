...
// ---------------------------------------------------------
ResourceMaterial::ResourceMaterial(unsigned long long id) : Resource(id, Resource::Type::material)
{
}
...
bool ResourceMaterial::LoadInMemory()
{
	if (GetExportedFile() != nullptr)
	{
		...
		unsigned int size = App->fs->Load(LIBRARY_MATERIAL_FOLDER, GetExportedFile(), &buffer);
...
// ---------------------------------------------------------
unsigned long long ResourceMaterial::Import(const aiMaterial* material, const char* source_file)
{
...
void ResourceMaterial::SetTexture(Texture texture, unsigned long long uid)
{
