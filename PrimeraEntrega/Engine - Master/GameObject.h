...
public:
	...
	bool Save(Config& config, std::map<unsigned int, unsigned int>* duplicate = nullptr) const;
	void Load(Config* config, std::map<GameObject*, unsigned int>& relations);
	...
	void FindComponents(Component::TypeComponent type, std::vector<Component*>& results) const;

	Component* FindFirstComponent(Component::TypeComponent type);
	const Component* FindFirstComponent(Component::TypeComponent type) const;
	...
	bool HasComponent(Component::TypeComponent type) const;
