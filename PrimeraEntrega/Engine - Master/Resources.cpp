...
// ---------------------------------------------------------
Resource::Resource(unsigned long long uid, Resource::Type type) : uid(uid), type(type)
{}
...
{
	static_assert(Resource::Type::other == 6, "String list needs update");
...
// ---------------------------------------------------------
unsigned long long Resource::GetUID() const
{
	return uid;
}
// ---------------------------------------------------------
...
// ---------------------------------------------------------
unsigned int Resource::CountReferences() const
{
	return loaded;
}
